...
The method for obtaining the installation package is the same as described in [Quick Start](./02.快速开始.md) .
...
For detailed parameter descriptions, refer to [Runtime Parameters](./04.运行参数说明.md) .
