...
title: Cluster Deployment Example
encrypt: false
permalink: /en/docker_cluster_deploy/
---
...
> [!NOTE]
>
> See [Runtime Parameters](../04.运行参数说明.md) for detailed parameter descriptions.
...
* The deployment method is similar to [standalone package deployment](./01.单机部署.md) , except that r-nacos supports startup through environment variables or configuration files. See [Runtime Parameters](../04.运行参数说明.md) for the corresponding settings.
