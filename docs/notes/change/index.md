...
[Full Changelog](https://github.com/nacos-group/r-nacos/compare/v0.6.2...HEAD)

**Closed issues:**

- r-nacos发生了panic [\#151](https://github.com/nacos-group/r-nacos/issues/151)

## [v0.6.2](https://github.com/nacos-group/r-nacos/tree/v0.6.2) (2024-10-21)
...
- 控制台用户管理中限制删除最后一个管理员，避免误操作。 [\#34](https://github.com/nacos-group/r-nacos/issues/34)

**Closed issues:**

- 优化命名空间管理逻辑，支持与配置中心、注册中心联动 [\#126](https://github.com/nacos-group/r-nacos/issues/126)

## [v0.6.1](https://github.com/nacos-group/r-nacos/tree/v0.6.1) (2024-10-13)
### What's Changed
...
- feat\(user\): prevent deletion of the last admin user [\#145](https://github.com/nacos-group/r-nacos/pull/145) ([a981008](https://github.com/a981008))
